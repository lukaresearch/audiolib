...
plot([0.5 1.5 1.5 2.5],[0 0 -1 -1],'ko-','linewidth',1,'markersize',3,...
    'MarkerFaceColor','k'); hold on
plot([1 2],[0 -1],'k>','MarkerFaceColor','k');
plot([1.5],[-0.5],'kV','MarkerFaceColor','k'); 
text(1.6,-0.5,sprintf('%.4g',b(1)),'fontname','symbol','fontsize',8,...
...
if M > 1
    for m = 2:M
        ...
        text(1.6+x0,-0.5,sprintf('%.4g',b(m)),'fontname','symbol',...
            'fontsize',8,'horizontalalignment','left');
        text(1+x0,0.1,'{\itz}^{-1}','fontname','times','fontsize',10,...
...
% Epilogue
ylim([-1.2 0.2]); xlim([0 M+2]); axis equal off;
