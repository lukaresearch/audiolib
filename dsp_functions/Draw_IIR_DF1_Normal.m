function Draw_IIR_DF1_Normal(b,a)
colordef white;
...
text(4.6,0,'{\ity}({\itn})','fontname','times','fontsize',10,...
...
for j = 1:(length(a)-1); 
    if a(j+1) ~= 0;
        ...
        plot(4,-j+0.5,'kV','MarkerFaceColor','k');
        text(3.5,-j+.25,sprintf('%.4g',-a(j+1)),'fontname','symbol',...
            'fontsize',8,'horizontalalignment','center');
